<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPanel.Master" CodeBehind="Group.aspx.cs" Inherits="KMS.Management.Group" %>
        ...
        <Columns>
            <dx:GridViewBandColumn Caption="Data" VisibleIndex="0">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="group_name" Caption="Group Name" Settings-AllowHeaderFilter="True">
                    ...
                    <dx:GridViewDataMemoColumn FieldName="group_desc" Caption="Group Description" />
                    <dx:GridViewDataComboBoxColumn FieldName="role_id" Caption="Role" Settings-AllowHeaderFilter="True">
                        <PropertiesComboBox ValueField="role_id" TextField="role_name" ValueType="System.Int32" TextFormatString="{0}" DisplayFormatString="{0}">
                            <ValidationSettings ErrorTextPosition="Bottom" SetFocusOnError="true" Display="Dynamic" ErrorDisplayMode="Text" ValidationGroup="Validate">
                                <RequiredField IsRequired="true" ErrorText="* Data required" />
                                <ErrorFrameStyle CssClass="small pl-0"></ErrorFrameStyle>
                            </ValidationSettings>
                        ...
                        <EditItemTemplate>
                            <dx:ASPxGridLookup ID="lookup_role" ClientInstanceName="lookup_role" runat="server" SelectionMode="Single"
                                KeyFieldName="role_id" TextFormatString="{0}" DisplayFormatString="{0}" AutoGenerateColumns="False"
                                OnInit="Role_Id_Init">
                                <ValidationSettings ErrorTextPosition="Bottom" SetFocusOnError="true" Display="Dynamic" ErrorDisplayMode="Text" ValidationGroup="Validate">
                                    <RequiredField IsRequired="true" ErrorText="* Data required" />
                                    <ErrorFrameStyle CssClass="small pl-0"></ErrorFrameStyle>
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="role_name" Caption="Role" />
                                    <dx:GridViewDataTextColumn FieldName="role_desc" Caption="Description" />
                                </Columns>
                                <GridViewProperties>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="col">
                                                    <dx:ASPxButton CssClass="align-self-center" runat="server" AutoPostBack="false" Text="Clear" Image-IconID="reports_none_16x16office2013"
                                                        ClientSideEvents-Click="function(s,e){ lookup_role.SetValue(null); }" />
                                                    <dx:ASPxButton CssClass="align-self-center" runat="server" AutoPostBack="false" Text="Refresh" Image-IconID="actions_refresh_16x16office2013"
                                                        ClientSideEvents-Click="function(s,e){ lookup_role.GetGridView().Refresh(); }" />
                                                </div>
                                                <div class="col-auto float-right">
                                                    <dx:ASPxButton CssClass="align-self-center" runat="server" AutoPostBack="false" Text="Close"
                                                        ClientSideEvents-Click="function(s,e){ lookup_role.ConfirmCurrentSelection();lookup_role.HideDropDown();lookup_role.Focus(); }" />
                                                </div>
                                            </div>
                                        </StatusBar>
                                    </Templates>
