<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPanel.Master" CodeBehind="Department.aspx.cs" Inherits="KMS.Management.Structure.Department" %>
        ...
        <Columns>
            <dx:GridViewBandColumn Caption="Data" VisibleIndex="0">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="department_name" Caption="Department Name" Width="40%" ReadOnly="false" Settings-AllowHeaderFilter="True">
                    ...
                    <dx:GridViewDataMemoColumn FieldName="department_desc" Caption="Description" Width="40%" ReadOnly="false" Settings-AllowHeaderFilter="True">
