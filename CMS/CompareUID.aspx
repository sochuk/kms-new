<%@ Page Language="C#" MasterPageFile="~/CPanel.Master" AutoEventWireup="true" CodeBehind="CompareUID.aspx.cs" Inherits="CMS.CompareUID" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxPageControl ID="Tabs" ClientInstanceName="Tabs" Width="100%" runat="server" ActiveTabIndex="0" EnableHierarchyRecreation="True">
        <TabPages>
            <dx:TabPage Text="Card UID VS NIK">
                <ContentCollection>
                    <dx:ContentControl>
                        <div id="sectionInfo">
                        ...
                        <dx:ASPxGridView runat="server" ID="grid" ClientInstanceName="grid"
                                ...
                                <dx:GridViewToolbar Name="Toolbar">
                                    <Items>
                                        ...
                                        <dx:GridViewToolbarItem Text="Download to" Image-IconID="export_export_16x16office2013" BeginGroup="true">
                                            <SubMenuTemplate>
                                                <dx:ASPxButton ID="CSVExport" CssClass="m-1" Image-IconID="mail_sendcsv_16x16office2013" OnClick="CSVCARDUIDExport_Click" runat="server" Text="CSV"></dx:ASPxButton>
                                                <dx:ASPxButton ID="ExcelExport" CssClass="m-1" Image-IconID="mail_sendxls_16x16office2013" OnClick="ExcelCARDUIDExport_Click" runat="server" Text="Excel"></dx:ASPxButton>
                                            </SubMenuTemplate>
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="CARDUID" Caption="CARD UID" Settings-AllowHeaderFilter="True" />
                                <dx:GridViewDataTextColumn FieldName="TOTAL" Caption="NIK Count" Width="200" MaxWidth="200" Settings-AllowHeaderFilter="True" />
    ...
    <dx:ASPxPopupControl ID="Popup" runat="server" ClientInstanceName="Popup"
        ...
        <ContentCollection>
            <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
                <dx:ASPxGridView runat="server" ID="gridDetail" ClientInstanceName="gridDetail" AutoGenerateColumns="true" CssClass="w-100">
    ...
    <dx:EntityServerModeDataSource runat="server" ID="Datasource" ContextTypeName="KMS.Context.KMSContext" TableName="CARD_CARDUID" OnSelecting="CARDUID_Selecting" />
</asp:Content>
